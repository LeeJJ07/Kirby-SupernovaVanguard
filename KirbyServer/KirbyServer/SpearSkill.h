...
public:
	SpearSkill(
		int masternum,
		int targetnum)
		: MonsterSkill(masternum, targetnum, MONSTERSKILLTYPE::SPEARSKILL, ECOLLIDERSHAPE::RECTANGLE, 0.2, 5, 36, 9, 3., { 0,0 }, { totalData.mdata[masternum].pos.x, totalData.mdata[masternum].pos.y }, { 5,0 })
	{
