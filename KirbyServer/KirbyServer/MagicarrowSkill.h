...
public:
	MagicArrowSkill(
		int masternum,
		int targetnum)
		: Skill(masternum, targetnum, SKILLTYPE::MAGICARROWSKILL, COLLIDERTYPE::RECTANGLE, 6, 5, 5, 15, 2., { 0,0 }, { totalData.udata[masternum].pos.x, totalData.udata[masternum].pos.y }, { 5,0 }),
